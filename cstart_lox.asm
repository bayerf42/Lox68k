; CSTART_LOX.ASM  -  C startup-code for Sirichote 68008 Lox port in RAM/emulator.

; Section definitions and memory layout

lomem      equ         $400            ; Lowest usable RAM address
himem      equ         $20000          ; Highest usable RAM address
progstart  equ         $10000          ; Code starts here to avoid assembler generating WRONG
                                       ; WORD-size JSR to static functions (forgetting sign)
